...
\pressetext{Verwendung von statischer Code-Analyse zur Vermeidung von Sicherheitslücken in Software}
\gruppe{4}
\mitglieder{Melanie Heiden \\ Michael Seydl \\ Anthony Thaler}
...
Die Auswertung zeigt, dass der Inhalt des Pressetextes von den Probanden
